...
def agregar_componentes_visualizacion(frame):
    ...
    imagen_pillow = Image.open("images/adelt.png")  # Reemplaza con la ruta de tu imagen
    ...
    imagen_redimensionada = imagen_pillow.resize((ancho_canvas, alto_canvas), Image.ANTIALIAS)
